...
namespace Movement.ECM2.Source.Components
{
    ...
    public class CharacterLook : MonoBehaviour
    {
        ...
        [Space(15f), Tooltip("Determines if the mouse cursor should be locked."), SerializeField,]
        bool _lockCursor;
        ...
        [Space(15f), Tooltip("Determines if pitch rotation should be clamped between minPitchAngle and maxPitchAngle."),
         SerializeField,]

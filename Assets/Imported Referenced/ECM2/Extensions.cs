...
namespace Movement.ECM2.Source.Common
{
    public static class Extensions
    {
        ...
        /// </summary>
        public static bool isZero(this Vector2 vector2) => vector2.sqrMagnitude < 9.99999943962493E-11;

        /// <summary>
        ///     Checks whether vector is near to zero within a tolerance.
        /// </summary>
        public static bool isZero(this Vector3 vector3) => vector3.sqrMagnitude < 9.99999943962493E-11;
        ...
        /// </summary>
        public static float dot(this Vector3 vector3, Vector3 otherVector3) => Vector3.Dot(vector3, otherVector3);
        ...
        public static Vector3 projectedOn(this Vector3 thisVector, Vector3 normal) =>
            Vector3.Project(thisVector, normal);
        ...
        public static Vector3 projectedOnPlane(this Vector3 thisVector, Vector3 planeNormal) =>
            Vector3.ProjectOnPlane(thisVector, planeNormal);
        ...
        public static Vector3 clampedTo(this Vector3 vector3, float maxLength) =>
            Vector3.ClampMagnitude(vector3, maxLength);
        ...
        public static Vector3 perpendicularTo(this Vector3 thisVector, Vector3 otherVector) =>
            Vector3.Cross(thisVector, otherVector).normalized;
        ...
        /// </summary>
        public static Vector3 relativeTo(this Vector3 vector3, Transform relativeToThis, Vector3 upAxis,
            bool isPlanar = true)
        {
            Vector3 forward = relativeToThis.forward;

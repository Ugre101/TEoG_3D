...
namespace Safe_To_Share.Scripts.GameUIAndMenus.DormUI.UI {
    public sealed class ViewDorm : MonoBehaviour {
        ...
        public void Setup() {
            ...
            var dormManager = DormManager.Instance;
            foreach (var mate in dormManager.DormMates)
                SetupDormMate(mate);
            var essenceStone = dormManager.Buildings.DormLodge.EssenceStone;
        ...
        static void ChangeGainType(int arg0) =>
            DormManager.Instance.Buildings.DormLodge.EssenceStone.GainType =

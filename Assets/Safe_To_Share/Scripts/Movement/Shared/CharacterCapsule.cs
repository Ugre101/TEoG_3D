...
namespace Safe_To_Share.Scripts.Movement.HoverMovement {
    ...
    public sealed class CharacterCapsule : MonoBehaviour {
        ...
        [SerializeField, Range(0.1f, 0.5f),] float minCapsule = 0.25f;
        ...
        public void SetHeight(float height) {
            ...
            currentHeight = Mathf.Clamp(currentHeight, minCapsule, 99f);
        ...
        public int SphereCastAllNonAlloc(Vector3 dir, float distance, LayerMask layerMask, out RaycastHit[] results,
                                         float radiusMod = 1f) {
        ...
        public IEnumerable<Collider> GetOverLapping(Vector3 capsuleBottom, LayerMask groundLayer) {
            var overLaps = OverlapCapsuleNonAlloc(capsuleBottom, overLapHits, groundLayer);

...
namespace Safe_To_Share.Scripts.Map {
    public sealed class MapData : MonoBehaviour {
        ...
        [field: SerializeField] public UnLockableMiniMapObject[] UnLockable { get; private set; } =
            Array.Empty<UnLockableMiniMapObject>();
        ...
        void EditorSetup() {
            ...
            if (gameObject.TryGetComponent(out Terrain terrain)) {
                ...
                Debug.Log(
                    "Map data isn't attached to a terrain, attach it or manually enter map size and map zero pos");
            }
        }
    }
}
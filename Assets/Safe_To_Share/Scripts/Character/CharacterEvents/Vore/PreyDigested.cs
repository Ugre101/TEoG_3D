...
namespace Character.CharacterEvents.Vore
{
    ...
    {
        protected override string LogText(BaseCharacter actor, BaseCharacter partner) => $"you have fully digested {partner.Identity.FirstName}";
    }
    ...
    {
        protected override string LogText(BaseCharacter actor, BaseCharacter partner) => $"{partner.Identity.FirstName}'s consciousness have fully merged with your cock as they are now a part of it.";
    }
}
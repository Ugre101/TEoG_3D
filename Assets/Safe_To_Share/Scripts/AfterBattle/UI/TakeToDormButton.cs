...
namespace Safe_To_Share.Scripts.AfterBattle.UI
{
    public class TakeToDormButton : MonoBehaviour
    {
        ...
        public void ShowOrgasmsLeft(BaseCharacter wantToTake)
        {
            ...
            float percent = Mathf.Min(1f, (float)enemy.SexStats.TotalOrgasms / enemy.CanTake.OrgasmsNeeded);
            pie.fillAmount = 1f - percent;
            int orgsLeft = enemy.CanTake.OrgasmsNeeded - enemy.SexStats.TotalOrgasms;

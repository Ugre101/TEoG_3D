...
Shader "Hidden/MicroSplat/Terrain_Base-1096200697" {
   Properties {
...
UNITY_INSTANCING_BUFFER_END(Terrain)
         ...
         ) 
      {
         ...
         #if !_DEBUG_USE_TOPOLOGY && !_MICROMESHTERRAIN && !_TERRAINBLENDABLESHADER && !_MICROMESH && !_MICROPOLARISMESH && !_MICRODIGGERMESH && !_MICROVERTEXMESH && defined(UNITY_INSTANCING_ENABLED) && !defined(SHADER_API_D3D11_9X)
      ...
      #endif
      {
         ...
         #if _PERPIXNORMAL || (!_MICROMESHTERRAIN && !_TERRAINBLENDABLESHADER && !_MICROMESH && !_MICRODIGGERMESH && !_MICROVERTEXMESH && defined(UNITY_INSTANCING_ENABLED) && !defined(SHADER_API_D3D11_9X))
